...
function doit()
  ...
  while can_continue do
    ...
    if waitForImage("dragon_keys.png", waitTime, "Waiting for Green Spin button") then
      local key = srFindImage("dragon_keys.png");
